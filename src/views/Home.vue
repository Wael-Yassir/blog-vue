<template>
  <div class="home">
    <Card-Item-List :articles="this.articles"
    style="margin: 0 5px"
    @onCardSelected="show"
    v-show="this.isCardListVisible"
    />
    <Article-Item v-show="!this.isCardListVisible"/>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      articles: [
        ...
        {
          title: 'title3',
          image: 'https://i.pinimg.com/originals/86/ff/b8/86ffb87572d657f335cd7cd828c70de3.jpg',
          summary: "Some quick example text to build on the card title and make up the bulk of the card's content.",
          date: '05.03.2021'
        },
        {
  ...
  methods: {
    show (isVisible) {
      this.isCardListVisible = !isVisible
    }
  }
}
</script>
